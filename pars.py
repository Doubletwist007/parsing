...
"""
код парсит base_url и получает (список словарей) и записывает их в CSV файл в табличном виде.
некоторые переменные в цикле комментить смысла нет, старался называть их так чтобы было понятно что они делают.
"""
